...
```sh
yarn add react-native-voice-voice-reworked

# or

npm i react-native-voice-voice-reworked --save
```
...
```sh
react-native link react-native-voice-voice-reworked
```
...
project(':@react-native-voice_voice').projectDir = new File(rootProject.projectDir, '../node_modules/react-native-voice-voice-reworked/android')
```
...
- Drag the Voice.xcodeproj from the react-native-voice-voice-reworked/ios folder to the Libraries group on Xcode in your poject. [Manual linking](https://reactnative.dev/docs/linking-libraries-ios.html)
...
{
  "expo": {
    "plugins": ["react-native-voice-voice-reworked"]
  }
}
```
...
```javascript
import Voice from 'react-native-voice-voice-reworked';
...
[npm]: https://img.shields.io/npm/v/react-native-voice-voice-reworked.svg?style=flat-square
[npm-url]: https://npmjs.com/package/react-native-voice-voice-reworked
